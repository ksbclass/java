...
public class ArrayEx10 {
	public static void main(String[] args) {
		int [] arr1 = {10,20,30};
		// arr1 배열보다 하나 더 큰 배열을 생성하여 arr1의 배열값을 저장하고 합계를 마지막요소에 저장하기
		...
		int[] arr3=new int[10];
		/*
		 * arraycopy(원본 배열, 원본배열의 시작 인덱스 값, 복사 배열,복사 배열의 시작 인덱스 값, 요소의 갯수)
		 * arr2 : 10 20 30 60
		...
		System.out.println();
		int[] arr5 =arr4; // 얕은복사. 두개의 참조 변수가 한개의 객체 참조
